...
import CaseCard from "components/ComercioExterior/CaseCardComercio";
...
export default function CardBeneficios() {
  ...
  const posts = useMemo(() => [
    ...
    return (
      <div className="bg-gray-200 relative max-w-[1970px] overflow-hidden pb-10 lg:pb-16 border border-orange-500 py-20">
          <h2 className="text-2xl md:text-3xl lg:text-4xl  font-bold tracking-tight text-azuls text-left border border-pink-500 px-6 md:px-10 xl:px-24 mb-10">
            Datos Fundamentales del Comercio Exterior
        </h2>

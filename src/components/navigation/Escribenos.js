            ...
            <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5">
                <div className="bg-gray-200 py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
                    <div className="mx-auto max-w-lg">
                        <h2 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">Conectate con Nosotros </h2>
                            <p className="mt-3 text-lg leading-6 text-gray-500">
                                ¿Tienes Alguna Duda? 
                                <br/>
                                <br/>
                                No dudes en contactarnos.
                                Estamos disponibles para responder a tus preguntas y ayudarte a sumergirte en el mundo empresarial.
                            </p>
                    ...
                    <div className="mt-6">
                        ...
                        <span className="ml-3">(+51)  999 999 111 </span>
                        </dd>
                    </div>
                    <div className="mt-3">
                        ...
                        <span className="ml-3">CieeEmpresarial@gamil.com</span>
                        </dd>
                    </div>
                    </dl>
                    <p className="mt-6 text-base text-gray-500">
                    ¿Eres Egresado y buscas Trabajo?{' '}
                    <a 
                    href="BolsaTrabajo" 
                    className="font-medium text-gray-700 underline"
                    
                    >
                        Revisa Nuestro Bolsa De trabajo y encuentra el trabajo ideal para ti ...
                    </a>
                    .
                    </p>
                </div>

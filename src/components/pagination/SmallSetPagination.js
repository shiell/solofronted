...
function SmallSetPagination({list_page, list, count}){
    ...
    const getNumbers = () => {
        ...
        let pageNumber = 1; //indica el incio de página
        ...
        <nav className="border-t border-gray-200 px-4 flex items-center justify-between sm:px-0">
            {
                ...
                <div className="-mt-px w-0 flex-1 flex">
                  <div
                    ...
                    className="cursor-pointer border-t-2 border-transparent pt-4 pr-1 inline-flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 border border-rojoficial"
                  >

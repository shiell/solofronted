import { connect } from "react-redux"; // v03 06:09:35 de active campaign
...
function OptIn(){ 
    ...
    const onSubmit=(e)=>{ //v03 m 06:14:00
        e.preventDefault()
        ...
        const fetchData = async () => {
            ...
            if(res.status === 200){ //*v03 m 06:20:00
                setTimeout(()=>{
    ...
    return(
        <Layout>
            ...
            <div className="overflow-hidden pt-4 sm:pt-12 lg:relative lg:py-48">
